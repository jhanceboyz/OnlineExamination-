...
<header class="inner">
    <div class="header-content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h1 id="homeHeading"><a href="index.php">Home</a> / <span>Reasoning Quiz Section</span></h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 template-form">
                <h2 class="contact-heading">Questions for <span>Reasoning Quiz:</span></h2>
                <div class="template-space"></div>
                <div  id="contactForm">
                <form action="reasoningcode.php" method="post">
                    <?php
                    include "connect.php";

                    $sql="Select * from quiztable where categoryid=3";
